...
const staticMarkers = [
  ...
  { code: "OCNTRK2", name: "OCNTRK2", coords: [1000, 1173], notams: "UNCONTROLLED AIRSPACE, USE COMMS FOR TRAFFIC POSITION INFO. PARTICAL BVIA CONTROL" },
  { code: "OCNTRK3", name: "OCNTRK3", coords: [930, 1819], notams: "UNCONTROLLED AIRSPACE, USE COMMS FOR TRAFFIC POSITION INFO. PARTICAL BREW CONTROL" },
  ...
  { code: "OCNTRK5", name: "OCNTRK5", coords: [1100, 1850], notams: "UNCONTROLLED AIRSPACE, USE COMMS FOR TRAFFIC POSITION INFO. PARTICAL BREW CONTROL" },
];
